...
<template>
	<Modal ref="modal">
		<template #header>
			<div class="p-4">
				<h3 class="text-lg text-gray-700">Gambar Produk</h3>
			</div>
		</template>
		<template #body>
			<div class="pt-4 pb-8 px-8">
				<div v-show="showFileUpload" class="mb-4">
					<label for="inputImg" class="text-sm font-medium text-gray-600 whitespace-nowrap block mb-2">Upload Gambar Produk</label>
